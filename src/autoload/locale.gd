...
const STRINGS := {
	...
	"menu.side": {"en": "Side", "zh": "阵营"},
	"side.title": {"en": "Choose Your Side", "zh": "选择阵营"},
	"side.hint": {
		"en": "Pick which side you play this session. Your loadout, perks and bloodweb are tracked per side. You can change this whenever you like.",
		"zh": "选择本次游玩的阵营。装备、技能与血网按阵营分别记录。随时可以改回来。",
	},
	"side.pick": {"en": "Change side", "zh": "切换阵营"},
	"side.survivor.desc": {"en": "Repair, hide, escape.\nA team of four.", "zh": "修机、躲藏、逃生。\n四人一队。"},
	"side.killer.desc": {"en": "Hunt, hook, sacrifice.\nAlone.", "zh": "追猎、挂钩、献祭。\n独自一人。"},
	"side.switchable": {"en": "switchable at any time", "zh": "可随时切换"},
