...
### 对手 AI
- **逃生者**：修机时会**自动分工**（避免几个人挤同一台）、被追时**绕着窗户和木板绕圈**
  而不是直线逃跑、并在杀手贴近时**主动放板**拖延。
  绕圈与下板是逃生者唯一能拖时间的手段 —— 杀手跑得更快，直线逃跑必被抓
- **杀手**：追击时**预判拦截**（瞄向逃生者的行进前方而不是他当前站的位置）、
  只在木板**真的挡在追击路线上**时才踩碎（附近有块板不等于挡路，为此停 2.6 秒是亏的）
- AI 能自己打完整局：修机 → 被发现 → 追逐 → 翻窗翻板 → 击倒 → 搬运 → 挂钩 → 献祭
